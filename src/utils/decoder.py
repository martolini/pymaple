...
class Decoder:
  def __init__(self):
    self.send = [82, 48, 120, 115]
    self.receive = [70, 114, 122, 82]
    self.receive_mapleversion = 83
    self.send_mapleversion = 0xFFFF - 83
    self.send_mapleversion = (((self.send_mapleversion >> 8) & 0xFF) | ((self.send_mapleversion << 8) & 0xFF00))
    self.receive_mapleversion = (((self.receive_mapleversion >> 8) & 0xFF) | ((self.receive_mapleversion << 8) & 0xFF00))
